...
namespace MVC3WebbyStuff
{
    /// <summary>
    /// Summary description for MVC3WebbyStuff
    /// </summary>
    ...
    public class MVC3WebbyStuff : System.Web.Services.WebService
    {
        [WebMethod]
        public List<MVC3WebbyStuff.Models.Employee> getAllEmployees()
        {
        ...
        public List<Manager> getAllManagers()
        {
            ...
            while (dr.Read())
            {
                emp.Add(new Manager((int)dr["ID"], (double)dr["Salary"], (String)dr["Name"], (String)dr["Department"], (int)dr["Reports"], (double)dr["BonusPerReport"]));
            }
        ...
        [WebMethod]
        public List<SalesEmployee> getAllSales()
        {
            List<SalesEmployee> emp = new List<SalesEmployee>();
            SqlConnection conn = new SqlConnection(@"Data Source = .; Database=AdventureWorks; Integrated Security=true;");
            conn.Open();
            ...
            while (dr.Read())
            {
                emp.Add(new SalesEmployee((int)dr["ID"], (double)dr["Salary"], (String)dr["Name"], (String)dr["Department"], (double)dr["ComissionRate"], (int)dr["NumOfSales"]));
            }
        ...
        public Employee getEmployeesByID(int ID)
        {
            ...
            while (dr.Read())
            {
                emp = new Employee((int)dr["ID"], (double)dr["Salary"], (String)dr["Name"], (String)dr["Department"]);
            }
            return emp;
        }
